...
export default function About(){
    return(
        <div className= 'w-full min-h-screen grid grid-rows-6 grid-cols-1 justify-items-stretch'>
            <header className= ' h-full container mx-auto row-span-1 bg-indigo-900 text-xs flex justify-center font-serif '>
                <Header2/>
            </header>
            <section className= 'overflow-auto row-span-4 container mx-auto '>
                <div className = {`pl-10 sm:pl-20 w-full h-full overflow-auto mx-auto text-gray-500 sm:text-lg  xl:w-1/2  `} >
